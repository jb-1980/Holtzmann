...
const GROUP_FINDER_QUERY = gql`
  query GroupFinder(
    $query: String, $tags: [String], $limit: Int, $offset: Int, $ip: String, $campuses: [String]
  ) {
...
const defaultArray = [];
@withRouter // this.props.router
@withCampusLocations // this.props.campusLocations
@connect(mapStateToProps) // this.props. tags, q, campuses, location this.props.dispatch
@withGroupFinder // this.props.data
